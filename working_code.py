...
######################################## CODE NEEDS TO BE WRITTEN
#user length preference is calculated and returned as a value

#anime_df gets a new coloumn with the difference between user preffered length (or input length) and the 
#indiviudal anime length
